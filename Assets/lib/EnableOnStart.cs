...
public class EnableOnStart : MonoBehaviour
{
    ...
    void Start(){
        ...
        cc = mas.player.GetPlayer().gameObject.GetComponent<CombatController>();
        pc = mas.player.GetPlayer();
        hc = mas.player.GetPlayer().gameObject.GetComponent<HookshotController>();
    ...
    public IEnumerator LerpHookshotColour(float t){   
        ...
        yield return new WaitForSeconds(hc.knife.cdTime / 10);
